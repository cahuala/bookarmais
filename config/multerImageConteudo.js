...
module.exports={
      //dest:path.resolve(__dirname,"..","tmp","videos","image"),
      storage: multer.diskStorage({
            destination:(req,file,cb)=>{
                  const dir = path.resolve(__dirname,"..","tmp","conteudo","image",req.params.id)
      ...
      fileFilter:(req,file,cb)=>{
            ...
            if(allowedMimes.includes(file.mimetype)){
              ...
              cb(new Error('Fichiro com formato inválido'))
            }
      },
}
